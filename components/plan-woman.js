...
<View style={{ flex: 1, backgroundColor: '#fff' }}>
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.categories}>
            <TouchableOpacity style={styles.categoryButton} onPress={() => navigation.navigate('PlanGeneral')}>
                <Text style={styles.categoryText}>Загальний</Text>
            </TouchableOpacity>
            <TouchableOpacity style={[styles.categoryButton, styles.activeCategory]} onPress={() => navigation.navigate('PlanWoman')}>
                <Text style={[styles.categoryText, styles.activeCategoryText]}>Для жінок</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity>
                <ImageBackground  style={styles.card} imageStyle={styles.cardImage}>
                    <View style={styles.overlay}>
                        <Text style={styles.cardText}>Програма тренувань для схуднення</Text>
                    </View>
                </ImageBackground>
            </TouchableOpacity>
        </View>

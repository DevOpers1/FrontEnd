...
<View style={{ flex: 1, backgroundColor: '#fff' }}>
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.categories}>
            ...
            <TouchableOpacity style={[styles.categoryButton, styles.activeCategory]} onPress={() => navigation.navigate('PlanMan')}>
            ...
            <TouchableOpacity>
                <ImageBackground  style={styles.card} imageStyle={styles.cardImage}>
                    <View style={styles.overlay}>
                        <Text style={styles.cardText}>Програма тренувань в залі на масу</Text>
                    </View>
                </ImageBackground>
            </TouchableOpacity>
        </View>
